...
#
get_filename_component(filename "/home/runner/work/meek/meek/build_hw/_deps/cpp_httplib-subbuild/cpp_httplib-populate-prefix/src/v0.18.3.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/meek/meek/build_hw/_deps/cpp_httplib-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cpp_httplib-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cpp_httplib-populate${i}")
